...
const AdminOrders = () => {
 ...
 const exportPDF = () => {
  ...
  doc.text(`Total Revenue: LKR ${totalRevenue.toFixed(2)}`, 40, finalY + 45);
                  ...
                  <ResponsiveContainer width="100%" height={340}>
                    <PieChart>
                      ...
                      <Legend 
                        ...
                        formatter={(value) => {
                          const item = revenueByProduct.find(p => p.product === value);
                          const pct = item && totalRevenue > 0 ? Math.round((item.revenue / totalRevenue) * 100) : 0;
                          return <span className="text-gray-700 ml-1">{value} <span className="font-semibold text-gray-900">({pct}%)</span></span>;
                        }}
                      />
                    </PieChart>
                  </ResponsiveContainer>
