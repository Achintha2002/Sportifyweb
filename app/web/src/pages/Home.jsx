                        ...
                        {categoriesLoading ? (
                            ...
                            >
                                ...
                                {rawCategoriesData.length > 0 && (
                                    ...
                                    >
                                        <img 
                                            src={rawCategoriesData[0].image.url.startsWith('http') ? rawCategoriesData[0].image.url : `${import.meta.env.VITE_SERVER_URL}/${rawCategoriesData[0].image.url.replace(/\\/g, "/")}`} 
                                ...
                                {rawCategoriesData.slice(1, 8).map((cat, index, arr) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <img 
                                                src={cat.image.url.startsWith('http') ? cat.image.url : `${import.meta.env.VITE_SERVER_URL}/${cat.image.url.replace(/\\/g, "/")}`} 
                                                alt={cat.name} 
