                        ...
                        {categoriesLoading ? (
                            ...
                            >
                                ...
                                {rawCategoriesData.length > 0 && (
                                    ...
                                    >
                                        <img 
                                            src={rawCategoriesData[0].image?.url?.startsWith('http') ? rawCategoriesData[0].image.url : `${import.meta.env.VITE_SERVER_URL || 'https://sportify-backend-theta.vercel.app'}/${(rawCategoriesData[0].image?.url || '').split('\\').join('/').replace(new RegExp('^/'), '')}`}
                                ...
                                {rawCategoriesData.slice(1, 8).map((cat, index, arr) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <img 
                                                src={cat.image?.url?.startsWith('http') ? cat.image.url : `${import.meta.env.VITE_SERVER_URL || 'https://sportify-backend-theta.vercel.app'}/${(cat.image?.url || '').split('\\').join('/').replace(new RegExp('^/'), '')}`}
                                                alt={cat.name} 
